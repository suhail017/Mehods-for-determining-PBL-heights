...
t_new=t_new(:);
 ...
 r = dlmread('output.txt');
 bc = r(:,(10:287));
%% Write the desired variables  
%Base_time

nccreate(file2,'base_time','Format','classic') ;
...
% Time offset
nccreate(file2,'time_offset','Dimensions',{'time',287},'datatype','int32') ;
...
% Backscatter
nccreate(file2,'backscatter','Dimensions',{'height',385,'time',287},'datatype','single') ;
...
ncwriteatt(file2,'/','starting_time','16 Apr 2015 00:00:00 UTC');
...
ncwriteatt(file2,'/','site_lat_N',31.7685);
ncwriteatt(file2,'/','site_lon_E',-106.5032);
